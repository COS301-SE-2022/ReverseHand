...
class JobListings extends StatelessWidget {
  ...
  const JobListings({Key? key, required this.store, required this.adverts})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Expanded(
        child: ListView(
            children: adverts
                .map((advert) => JobListing(store: store, advert: advert))
                .toList()),
      ),
      Align(
...
class JobListing extends StatelessWidget {
  ...
  const JobListing({Key? key, required this.store, required this.advert})
      : super(key: key);
