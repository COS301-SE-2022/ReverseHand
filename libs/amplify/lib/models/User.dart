...
class User extends Model {
  ...
  const User._internal({required this.id, required name, required email, createdAt, updatedAt}): _name = name, _email = email, _createdAt = createdAt, _updatedAt = updatedAt;
