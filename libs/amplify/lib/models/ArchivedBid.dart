...
class ArchivedBid extends Model {
  ...
  const ArchivedBid._internal({required this.id, tradesman, date_created, date_closed, price_lower, price_upper, required advert, accepted_bid, createdAt, updatedAt}): _tradesman = tradesman, _date_created = date_created, _date_closed = date_closed, _price_lower = price_lower, _price_upper = price_upper, _advert = advert, _accepted_bid = accepted_bid, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'tradesman': _tradesman, 'date_created': _date_created?.format(), 'date_closed': _date_closed?.format(), 'price_lower': _price_lower, 'price_upper': _price_upper, 'advert': _advert, 'accepted_bid': _accepted_bid?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
