...
class SetPlaceAction extends ReduxAction<AppState> {
    ...
    if (state.locationResult != null) {
        ...
        case "Tradesman":
          ...
          userDomains.add(Domain(
            ...
            coordinates: Coordinates(
                lat: state.locationResult!.coordinates.lat, lng: state.locationResult!.coordinates.lng),
          ));
          return state.copy(
            userDetails: state.userDetails!.copy(domains: userDomains,location: null),
          );
        default:
        return null;
      }
      ...
      return state.copy(
        error: ErrorType.locationNotCaptured
      );
    }
  }
