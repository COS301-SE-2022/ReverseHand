...
class Bid extends Model {
  ...
  const Bid._internal({required this.id, tradesman, required advert, price_lower, price_upper, date_created}): _tradesman = tradesman, _advert = advert, _price_lower = price_lower, _price_upper = price_upper, _date_created = date_created;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'tradesman': _tradesman, 'advert': _advert, 'price_lower': _price_lower, 'price_upper': _price_upper, 'date_created': _date_created?.format()
  };
